...
## Most depended-on native (C extension) gems

The gems the community effectively cannot drop: native extensions that many other gems
require at runtime. Cross-joined with the c-extensions report.

| Native gem | Dependents |
|---|---|
| json | 7518 |
| nokogiri | 6900 |
| eventmachine | 1098 |
